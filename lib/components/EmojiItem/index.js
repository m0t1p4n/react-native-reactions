...
const EmojiItem = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Animated.View, { style: [styles.root, emojiContainerStyle], onLayout: onLayout },
            React.createElement(TouchableOpacity, { hitSlop: { bottom: 30, top: 30 }, ref: childRef, onPress: onEmojiPress },
