...
const ReactionView = (props) => {
    ...
    const subContainer = useAnimatedStyle(() => ({
        position: 'absolute',
        zIndex: 10,
    ...
    return (React.createElement(SafeAreaView, { ref: rootRef, style: [{ zIndex: hoverIndex, elevation: hoverIndex }] },
        isCardOpen && (React.createElement(AnimatedView, { style: subContainer },
        ...
        React.createElement(AnimatedView, { onLayout: event => {
        ...
        }, ...panResponder.panHandlers }, React.isValidElement(children) && (React.createElement(AnimatedPressable, { ...touchableProps, hitSlop: { top: 20, left: 20, right: 20, bottom: 20 }, disabled: disabled, onLongPress: () => {
