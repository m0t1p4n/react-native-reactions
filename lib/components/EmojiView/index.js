...
const EmojiView = ({ onStartShouldSetResponder, getEmojiViewCoordinates, ...props }) => {
    ...
    const emojiBox = useAnimatedStyle(() => ({
        flexDirection: 'row',
        padding: styles.emojiBox.padding,
        backgroundColor: styles.emojiBox.backgroundColor,
        borderRadius: styles.emojiBox.borderRadius,
        shadowColor: styles.emojiBox.shadowColor,
        shadowOffset: styles.emojiBox.shadowOffset,
        shadowOpacity: styles.emojiBox.shadowOpacity,
        shadowRadius: styles.emojiBox.shadowRadius,
        elevation: styles.emojiBox.elevation,
        ...(cardStyle || {}),
    }));
    return (React.createElement(AnimatedView, { style: [subContainer, container], ...panResponder.panHandlers, onResponderRelease: () => setTouchRelease(true) },
        ...
        React.createElement(AnimatedView, { style: emojiBox, ref: measureRef, onLayout: () => {
                var _a;
